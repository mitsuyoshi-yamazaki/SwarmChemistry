...
public extension Recipe {
  ...
  static var slicer: Recipe {
    return self.init(Raw.slicer)! // swiftlint:disable:this force_unwrapping
  }

  static var oscillator: Recipe {
    return self.init(Raw.oscillator)! // swiftlint:disable:this force_unwrapping
  }

  // MARK: -
  static var insurmountableWall: Recipe {
    return self.init(Raw.insurmountableWall)! // swiftlint:disable:this force_unwrapping
  }

  static var cellWithTwoNuclei: Recipe {
    return self.init(Raw.cellWithTwoNuclei)! // swiftlint:disable:this force_unwrapping
  }

  static var multicellularity: Recipe {
    return self.init(Raw.multicellularity)! // swiftlint:disable:this force_unwrapping
  }

  static var jellyFish: Recipe {
    return self.init(Raw.jellyFish)! // swiftlint:disable:this force_unwrapping
  }

  static var noWaitThisWay: Recipe {
    return self.init(Raw.noWaitThisWay)! // swiftlint:disable:this force_unwrapping
  }

  static var recombiningBlobs: Recipe {
    return self.init(Raw.recombiningBlobs)! // swiftlint:disable:this force_unwrapping
  }

  static var playingCatch: Recipe {
    return self.init(Raw.playingCatch)! // swiftlint:disable:this force_unwrapping
  }

  static var pulsatingEye: Recipe {
    return self.init(Raw.pulsatingEye)! // swiftlint:disable:this force_unwrapping
  }

  static var chaosCells: Recipe {
    return self.init(Raw.chaosCells)! // swiftlint:disable:this force_unwrapping
  }

  static var aggressivePredator: Recipe {
    return self.init(Raw.aggressivePredator)! // swiftlint:disable:this force_unwrapping
  }

  static var fastWalkerAndSlowFollower: Recipe {
    return self.init(Raw.fastWalkerAndSlowFollower)! // swiftlint:disable:this force_unwrapping
  }

  static var swinger: Recipe {
    return self.init(Raw.swinger)! // swiftlint:disable:this force_unwrapping
  }

  static var rotary: Recipe {
    return self.init(Raw.rotary)! // swiftlint:disable:this force_unwrapping
  }

  static var weddingRing: Recipe {
    return self.init(Raw.weddingRing)! // swiftlint:disable:this force_unwrapping
  }

  static var turbulentRunner: Recipe {
    return self.init(Raw.turbulentRunner)! // swiftlint:disable:this force_unwrapping
  }

  static var blobs: Recipe {
    return self.init(Raw.blobs)! // swiftlint:disable:this force_unwrapping
  }

  static var linearOscillator: Recipe {
    return self.init(Raw.linearOscillator)! // swiftlint:disable:this force_unwrapping
  }
